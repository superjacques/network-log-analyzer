...
The application also selects the portable `clam` ttk theme on macOS because some older Aqua Tk combinations can render the window surface without visible themed controls.
